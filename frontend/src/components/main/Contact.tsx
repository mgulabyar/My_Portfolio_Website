...
// import {  Mail, MapPin, ShieldCheck, Send, PhoneCall, Clock } from 'lucide-react';
...
//             <div className="w-full max-w-70 rounded-2xl overflow-hidden border border-white/10 p-1 bg-slate-950/40 shadow-inner mt-4 self-center lg:self-start">
//               <img 
//                 src={contactGif} 
//                 alt="Developer Support" 
//                 className="w-full h-auto object-cover rounded-xl filter brightness-[0.95]" 
//                 onError={(e) => {
...
//             </a>
//             <a href="https://wa.me/923001234567" target="_blank" rel="noreferrer" className="text-sm font-bold text-slate-300 hover:text-brand-orange transition-colors duration-200 flex items-center gap-1">
...
//             </div>
//             <span className="text-xs uppercase tracking-widest font-extrabold text-slate-400">Office Location</span>
//             <span className="text-sm font-bold text-white">Karachi, Pakistan</span>
//             <span className="text-xs text-slate-400 font-medium">Available for Global Remote Work & Travels</span>
//           </motion.div>
