...
//                 onError={(e) => {
//                   e.currentTarget.src =
//                     "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExdDJuYzJ1Z3h6dXVzcnlhMzk5M2xjdjV0dHF0OHdtOWx1eG91cmRndCZjdD1n/6ozwFj8tCdxpG7gA5D/giphy.gif";
//                 }}
//               />
//             </div>
//           </motion.div>
...
//                 >
//                   <option value="Web Development" className="bg-brand-dark">
//                     MERN Stack Web Dev
//                   </option>
//                   <option
//                     value="Google Workspace Add-ons"
//                     className="bg-brand-dark"
//                   >
//                     Google Workspace Add-ons
//                   </option>
//                   <option value="MS Office Add-ins" className="bg-brand-dark">
//                     MS Office 365 Add-ins
//                   </option>
//                   <option value="AI Integration" className="bg-brand-dark">
//                     AI & VBA Automation
//                   </option>
//                   <option value="VBA Macros" className="bg-brand-dark">
//                     Desktop Macros & Scripts
//                   </option>
...
import { Mail, ShieldCheck, Clock, Building } from 'lucide-react';
import contactImg from '../../assets/Voice chat-amico.png';
import Footer from '../footer/Footer';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center px-6 md:px-12">
          ...
          >
            ...
            <img
              src={contactImg}
              alt="GulabYar Support Workflow"
              className="w-full h-auto max-h-96 object-contain brightness-[0.95]"
              onError={(e) => {
