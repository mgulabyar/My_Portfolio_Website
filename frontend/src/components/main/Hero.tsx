...
export default function Hero() {
  ...
  const techStack = [
    "ASP.NET Core", "React", "Google Workspace Add-ons", "Node.js", "Express", "MongoDB", "TypeScript", 
      ...
      >
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6 w-full mt-4">
          ...
          >
            ...
            <span className="text-xl font-black text-white tracking-wide">04+ Years</span>
          ...
          >
            ...
            <span className="text-xl font-black text-white tracking-wide">50+ Apps</span>
          ...
          >
            ...
            <span className="text-xl font-black text-white tracking-wide">10k+ Hours</span>
          ...
          >
            ...
            <span className="text-xl font-black text-white tracking-wide">99% Client</span>
      ...
      >
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6 w-full mt-4">
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">Full-Stack MERN Architectures</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Designing robust, highly responsive, and database-secured custom web portals utilizing modern server side models.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">Office & Workspace Add-ins</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Building tailored enterprise tools with Office.js for Outlook, Word, Excel, and dynamic Google Apps Script add-ons.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">Intelligent AI & VBA Automations</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Eliminating manual business operations by connecting advanced OpenAI/GPT APIs with complex background script engines.</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6 w-full mt-4">
          ...
          >
            ...
            <h4 className="text-sm font-bold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2 tracking-wide">Strict SLA Timelines</h4>
          ...
          >
            ...
            <h4 className="text-sm font-bold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2 tracking-wide">Elite System Security</h4>
          ...
          >
            ...
            <h4 className="text-sm font-bold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2 tracking-wide">Dynamic Control Hub</h4>
