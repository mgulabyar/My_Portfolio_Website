...
export default function Hero() {
  ...
  const techStack = [
    "ASP.NET Core", "React", "Node.js", "Express", "MongoDB", "TypeScript", 
  ...
  return (
    <section id="home" className="pt-24 pb-8 sm:pt-32 sm:pb-12 lg:pt-40 lg:pb-16 flex flex-col justify-between select-none">
      <motion.div 
      ...
      >
        ...
        >
          ...
          <div className="relative w-full max-w-70 xs:max-w-[300px] sm:max-w-[320px] md:max-w-82.5 rounded-2xl overflow-hidden border border-white/5 hover:border-brand-orange/30 transition-all duration-700 ease-out p-1 bg-slate-900/40">
            <img 
      ...
      <motion.div 
        ...
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
        className="w-full mt-24 flex flex-col  items-center gap-2"
      >
        <motion.h3 
          variants={slowSlideUp}
          className="text-2xl sm:text-4xl font-extrabold text-white text-center"
        >
        ...
        <motion.p 
          variants={slowSlideUp}
          className="text-xs sm:text-lg text-slate-400 text-center max-w-lg mx-auto leading-relaxed mb-4 font-light"
        >
      ...
      >
        ...
        <motion.p 
          variants={slowSlideUp}
          className="text-xs sm:text-sm text-slate-400 text-center max-w-lg mx-auto leading-relaxed mb-4 font-light"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-4">
          <motion.div 
            variants={cardLeft}
            className="p-6 rounded-xl bg-slate-900/40 border border-white/5 hover:border-brand-orange/30 transition-all duration-500 flex flex-col gap-3 group cursor-pointer"
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300">Full-Stack MERN Architectures</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">Designing robust, highly responsive, and database-secured custom web portals utilizing modern server side models.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300">Office & Workspace Add-ins</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">Building tailored enterprise tools with Office.js for Outlook, Word, Excel, and dynamic Google Apps Script add-ons.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300">Intelligent AI & VBA Automations</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">Eliminating manual business operations by connecting advanced OpenAI/GPT APIs with complex background script engines.</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-4">
          ...
          >
            ...
            <h4 className="text-sm font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2">Strict SLA Timelines</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Every single development roadmap is strictly aligned with pre-planned sprint cycles to guarantee standard delivery.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-sm font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2">Elite System Security</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Implementing strict NoSQL query filters, HPP guards, rate limits, and SSL API routing protection protocols.</p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-sm font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 mt-2">Dynamic Control Hub</h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light max-w-xs">Configured with global dynamic CMS models allowing fast data switching without requiring raw code recompilation.</p>
          </motion.div>
        </div>
      </motion.div>
