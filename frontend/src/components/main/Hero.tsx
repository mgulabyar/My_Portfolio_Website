...
// import { ArrowUpRight, Download, Code, Cpu, ShieldCheck } from "lucide-react";
...
//         >
//           <div className="absolute inset-0 bg-linear-to-tr from-brand-orange/20 to-brand-amber/10 rounded-2xl blur-3xl animate-pulse"></div>
...
//           >
//             I am a professional Full-Stack Developer with 4 years of experience,
//             specializing in the MERN stack, Python, ASP.NET Core, and Angular.
//             My expertise includes building custom Office Add-ins, Google
//             Add-ons, dynamic VBA/Macros, and seamless AI integration services.
//           </motion.p>
//           <motion.div
//             variants={slowSlideUp}
