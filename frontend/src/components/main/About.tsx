...
// import { CheckCircle2, ArrowUpRight, Layers, Award, Shield } from 'lucide-react';
...
//       <div className="w-full h-1 bg-linear-to-r from-transparent via-white/10 to-transparent my-20"></div>
...
//             <div className="h-9 w-9 bg-brand-orange/10 border border-brand-orange/20 flex items-center justify-center rounded-xl">
