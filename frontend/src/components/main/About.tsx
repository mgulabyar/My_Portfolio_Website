  ...
  return (
    <section id="about" className="py-20 border-t border-white/5">
      <motion.div
        ...
        className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-10 px-6 md:px-12"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-2">
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">
              01. Milestone-Based Sprints
            </h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">
              Every project roadmap is chunked into rapid, weekly iterations.
              This ensures continuous feedback loops, absolute transparency, and
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">
              02. Complex System Integration
            </h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">
              Seamlessly connecting secure cloud databases, high-performance web
              frontends, and backend server models with native background
              scripting engines.
            </p>
          </motion.div>
          ...
          >
            ...
            <h4 className="text-base font-extrabold text-white group-hover:text-brand-orange transition-colors duration-300 tracking-wide">
              03. Secure Enterprise Coding
            </h4>
            <p className="text-xs text-slate-400 leading-relaxed font-light">
              Adhering strictly to security standards by utilizing clean JWT
              sessions, NoSQL injection preventions, HPP query protections, and
              CORS definitions on all APIs.
            </p>
          </motion.div>
        </div>
      </motion.div>
