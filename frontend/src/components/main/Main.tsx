...
export default function Main() {
  ...
  const slideLeftToRight = {
    ...
    visible: { 
      opacity: 1, 
      x: 0,
      transition: { duration: 1, ease: "easeOut" as const } // Fixed TS error with 'as const'
    }
  };
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 md:px-12 pt-32 pb-20 min-h-screen flex items-center">
      <motion.div 
